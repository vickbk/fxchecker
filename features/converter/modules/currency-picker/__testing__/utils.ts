export const [
  ...
  SEARCH_CURRENCY_LABEL_QUOTE = "Enter the currency you like (quote)",

  SEARCH_BASE_PLACEHOLDER = "Search for base currency",
  SEARCH_QUOTE_PLACEHOLDER = "Search for quote currency",
